...
## Project Structure
    ...
    ├── testapiautoconnecto_94633  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_94633`
...
2. Clone this repo and `cd testapiautoconnecto_94633`
